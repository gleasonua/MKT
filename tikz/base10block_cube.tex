...
\draw ($ (bf)!\tthree!(br) $) -- ($ (tf)!\tthree!(tr) $) -- ($ (tl)!\tthree!(tb) $);
\draw ($ (bf)!\tfour!(br) $) -- ($ (tf)!\tfour!(tr) $) -- ($ (tl)!\tfour!(tb) $);
\draw ($ (bf)!\tfive!(br) $) -- ($ (tf)!\tfive!(tr) $) -- ($ (tl)!\tfive!(tb) $);
\draw ($ (bf)!\tsix!(br) $) -- ($ (tf)!\tsix!(tr) $) -- ($ (tl)!\tsix!(tb) $);
\draw ($ (bf)!\tseven!(br) $) -- ($ (tf)!\tseven!(tr) $) -- ($ (tl)!\tseven!(tb) $);
\draw ($ (bf)!\teight!(br) $) -- ($ (tf)!\teight!(tr) $) -- ($ (tl)!\teight!(tb) $);
\draw ($ (bf)!\tnine!(br) $) -- ($ (tf)!\tnine!(tr) $) -- ($ (tl)!\tnine!(tb) $);
